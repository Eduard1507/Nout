...
// для того что бы работать с этими экземпляррами в данном классе
    ...
    public List<Laptop> filter(Set<Laptop> laptop) {
        ...
        System.out.println("Здрасвуйте, Укажите какие параметры для ноут бука вы бы хотели иметь." +
    ...
    public Set<Laptop> newFilter(Set<Laptop> laptop) {
        ...
        System.out.println("Здрасвуйте, Укажите номер критерия для фильрации ноутбуков," +
